          ...
          <div className="mb-7 md:mb-20 flex max-w-7xl flex-col items-start justify-center pt-10 text-white sm:mt-18 md:pt-0 lg:mt-6">
            <h1 className="font-space-grotesk text-4xl tracking-tight leading-tight font-semibold sm:text-6xl md:text-7xl lg:text-8xl xl:text-[130px]">
              <span className="flex items-center gap-4">
                <span>Hi I&apos;m Keshav </span>
                <a
                  href="https://www.linkedin.com/in/keshav-agrawal-02b4861b0"
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="Keshav's LinkedIn profile"
                  className="text-[#27272A] hover:text-blue-500 hover:rotate-10 transform-fill transition-all duration-150 ease-in-out cursor-pointer inline-flex items-center"
                >
                  <svg className="w-12 h-12 sm:w-24 sm:h-24" width="98" height="98" viewBox="0 0 70 70" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
            ...
            <p className="font-geist-pixel mt-4 w-full text-sm text-secondary sm:mt-6 sm:w-[80%] sm:text-base md:mt-2 md:w-[70%] md:text-lg lg:w-[60%] lg:text-xl xl:w-[45%] xl:text-2xl">
              I build scalable web applications and distributed systems that look and feel good to use. Full-Stack Developer & Software Engineer.
            </p>

            <div className="mt-6 flex flex-wrap gap-3 md:gap-6 sm:mt-6 md:mt-8">
              <RingButton href="mailto:keshavagrawal273@gmail.com" text="Get in Touch" ariaLabel="Get in touch via email" icon={Calendar} />
              <OpenToWorkNote />
            </div>
          </div>
        </div>
