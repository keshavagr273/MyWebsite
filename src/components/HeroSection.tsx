          ...
          <div className="mb-7 md:mb-20 flex max-w-7xl flex-col items-start justify-center pt-10 text-white sm:mt-18 md:pt-0 lg:mt-6">
            <div className="font-space-grotesk text-4xl tracking-tight leading-tight  font-semibold  sm:text-6xl md:text-7xl lg:text-8xl xl:text-[130px]">
              <div className="flex items-center gap-4">
                ...
                <span onClick={() => window.open("https://www.linkedin.com/in/keshav-agrawal-02b4861b0", "_blank", "noopener,noreferrer")} className="text-[#27272A] hover:text-blue-500 hover:rotate-10 transform-fill transition-all duration-150 ease-in-out cursor-pointer">
            ...
            <div className="mt-6 flex flex-wrap gap-3 md:gap-6 sm:mt-6 md:mt-8">
              <a href="mailto:keshavagrawal273@gmail.com">
                <RingButton text="Get in Touch" icon={Calendar} />
              </a>
              <OpenToWorkNote />
            </div>
          </div>
