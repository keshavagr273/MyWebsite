...
const TakethisSlot = () => {
  return (
    <div className='col-span-1 h-full '>
        <a
      href='https://github.com/sponsors/keshavagr273'
      target='_blank'
      rel='noopener noreferrer'
      aria-label='Open GitHub Sponsors for keshavagr273'
    ...
    >
      <div className='h-full bg-grey p-4 rounded flex flex-col items-center justify-center border-2 border-dashed border-[#1C1C1F] hover:border-neutral-700 transition-all duration-150 ease-in-out '>
        <div className='flex flex-col items-center justify-center gap-3 text-center'>
          ...
          <iframe src="https://github.com/sponsors/keshavagr273/button" title="Sponsor keshavagr273" height="32" width="114" className='border border-neutral-600 rounded pointer-events-none'></iframe>
        </div>
      </div>
    </a>
    </div>
