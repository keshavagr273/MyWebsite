...
const Avatar = ({
  ...
  <motion.span
    ...
    transition={transition}
    className={cn(
      "grid size-7 shrink-0 place-items-center overflow-hidden rounded-full bg-black text-[12px] font-semibold font-space-grotesk uppercase text-white border border-neutral-700 ring-2 ring-background",
      className,
    )}
  >
...
const RepoRow = ({
  ...
  const content = (
    <>
      ...
      {typeof repo.count === "number" && repo.count > 0 && (
