...
const email = "keshavagrawal273@gmail.com";
const repo = "https://github.com/keshavagr273";
...
const columns: FootColumn[] = [
  {
    title: "Crafted by",
    links: [
      { text: "Keshav Agrawal", href: "https://www.linkedin.com/in/keshav-agrawal-02b4861b0", underline: true },
  ...
  },
  {
    title: "Project",
    links: [
      { text: "GitHub Profile", href: repo },
      { text: "ClassMate Repo", href: "https://github.com/keshavagr273/ClassMate" },
    ],
  },
];
    ...
    <section className="relative overflow-hidden bg-[#09090B] text-white">
      <div className="px-[3%] pt-20 pb-0 sm:pt-24">
        ...
        <div className="mt-12 flex flex-wrap items-center gap-x-5 gap-y-2 border-t border-[#1C1C1F] pt-6 font-geist-mono text-xs text-secondary sm:text-sm">
          <span>© {new Date().getFullYear()} Keshav Agrawal</span>
        </div>
      </div>
